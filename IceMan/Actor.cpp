...
void Iceman::doSomething() {
    ...
    if (getWorld()->getKey(ch) == true) {
        switch (ch) {
        case KEY_PRESS_UP:
            if (getDirection() == up && getWorld()->isBouldery(ch) == false) {
        ...
        case KEY_PRESS_DOWN:
            if (getDirection() == down && getWorld()->isBouldery(ch) == false) {
        ...
        case KEY_PRESS_LEFT:
            if (getDirection() == left && getWorld()->isBouldery(ch) == false) {
        ...
        case KEY_PRESS_RIGHT:
            if (getDirection() == right && getWorld()->isBouldery(ch) == false) {
...
void Boulder::doSomething() {
    ...
    if (getState() == WAIT) {
        ...
        setState(WAIT); // setting FALL to WAIT
        return;
    }
